...
class GenerateQuizQuestionUseCaseTest {
    ...
    @Test
    fun `correct answer is among the options`() =
        runTest {
            val question = useCase()
    ...
    @Test
    fun `muchik term and correct answer are not blank`() =
        runTest {
            val question = useCase()
            assertNotNull(question)
    ...
    @Test
    fun `consecutive questions are different`() =
        runTest {
